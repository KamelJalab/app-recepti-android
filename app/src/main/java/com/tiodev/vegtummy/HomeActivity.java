...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        salad.setOnClickListener(v -> start("Salad","Салати"));
        main.setOnClickListener(v -> start("Dish", "Основно"));
        drinks.setOnClickListener(v -> start("Drinks", "Напитки"));
        dessert.setOnClickListener(v -> start("Desserts", "Десерти"));
